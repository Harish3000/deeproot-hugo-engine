...
- Theme Tokens: `deeprootSite/data/theme.json`.
- Config: `deeprootSite/hugo.toml` + `deeprootSite/config/_default/*.toml`.
- Content Root (English): `deeprootSite/content/english`.
- Layouts & Partials: `layouts/`.
- CSS Source: `assets/css/` (`main.css` is the Tailwind entry).
- Tailwind Plugins (custom): `deeprootSite/tailwind-plugin/`.
...
File: `deeprootSite/data/theme.json`
...
Location: `deeprootSite/hugo.toml` and `deeprootSite/config/_default/`
...
English root: `deeprootSite/content/english/`
...
- Custom plugin JS (for Tailwind theme & grid): `deeprootSite/tailwind-plugin/`.
...
Files: `deeprootSite/tailwind-plugin/tw-theme.js`, `deeprootSite/tailwind-plugin/tw-bs-grid.js`.
